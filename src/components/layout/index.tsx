    ...
    <div style={{ ...rootStyle, ...style }} className={className}>
      ...
      >
        ...
        >
          ...
          >
            {leftSidebar ? <Sidebar style={{ ...fixedSidebarStyle, ...leftSidebarStyle }}>{leftSidebar}</Sidebar> : null}
            <div
              style={{
                flex: 1,
                flexDirection: "column",
            ...
            {rightSidebar ? <Sidebar style={{ ...fixedSidebarStyle, ...rightSidebarStyle }}>{rightSidebar}</Sidebar> : null}
          </div>
          {simpleFooter}
        </div>
      </div>
